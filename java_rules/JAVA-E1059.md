...
**ID:** `JAVA-E1059` | **Lien:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-E1059)
...
* Performing a string concatenation operation with non-constant strings (This will cause Java to allocate a `StringBuilder` to create the resultant string).
