# Audit: XMLReader may be vulnerable to XXE attacks
**ID:** `JAVA-A1060` | **Lien:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-A1060)

![Critical](https://img.shields.io/badge/severity-critical-red) ![Security](https://img.shields.io/badge/type-security-red)

This code appears to use an `XMLReader` instance without setting the correct input processing flags. This could allow [XML External Entity (XXE)](https://en.wikipedia.org/wiki/XML_external_entity_attack) attacks to easily occur.
...
## Bad Practice
In the example below, an `XMLReader` has been created which neither prevents processing of DTD elements (which would completely stop any XXE or XEE attacks) nor prevents access to external files via secure processing.
...
* Using the [** `XMLConstants.FEATURE\_SECURE\_PROCESSING` **](https://docs.oracle.com/javase/8/docs/api/javax/xml/XMLConstants.html#FEATURE_SECURE_PROCESSING) flag
