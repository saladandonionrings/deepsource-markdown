...
**ID:** `JAVA-E0028` | **Link:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-E0028)
...
* Push`a`'s value onto the stack* Copy the value once* Increment the copied value* Pop`a`'s value from the stack
