...
**ID:** `JAVA-E1065` | **Link:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-E1065)
...
* For primitives, it is`0`(or the floating point equivalent)* For descendants of`Object`, the default value is`null`.
