...
**ID:** `JAVA-S0326` | **Link:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-S0326)
...
* Assign the resource to any fields* Pass it to other methods that might close it* Return it* Close the resource object on all possible exception paths out of the method
