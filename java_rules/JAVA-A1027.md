...
**ID:** `JAVA-A1027` | **Link:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-A1027)
...
```
* Data such as request parameters, headers and cookies should be handled carefully, as they are the largest attack surfaces.* Use a data sanitization library like OWASP's[ESAPI](https://owasp.org/www-project-enterprise-security-api/)to reduce the amount of work you need to do.
