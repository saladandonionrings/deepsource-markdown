...
**ID:** `JAVA-P1000` | **Link:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-P1000)
...
* They occupy more space in memory ([A header with a minimum of 8 bytes](https://stackoverflow.com/a/26416983/6325886)+ the primitive value)* They force the JVM to allocate unnecessarily when boxing primitives into their object versions.
