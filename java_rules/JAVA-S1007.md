...
**ID:** `JAVA-S1007` | **Link:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-S1007)
...
* It covers only parameters, not headers and side-channel inputs* The chain of replace functions can be bypassed easily (see example below)* It's a black-list of very specific bad patterns (rather than a whitelist of good/valid input)
