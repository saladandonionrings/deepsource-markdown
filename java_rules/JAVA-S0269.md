...
**ID:** `JAVA-S0269` | **Link:** [DeepSource](https://deepsource.com/directory/java/issues/JAVA-S0269)
...
* Assign the stream to any fields* Pass it to other methods that might close it* Return it* Close the stream on all possible exception paths out of the method
