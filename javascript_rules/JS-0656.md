...
**ID:** `JS-0656` | **Link:** [DeepSource](https://deepsource.com/directory/javascript/issues/JS-0656)

![Critical](https://img.shields.io/badge/severity-critical-red)![Bug Risk](https://img.shields.io/badge/type-bug_risk-green)

In the recent release of Vue 3.0,

* Using numbers, i.e. keyCodes, as`v-on`modifiers is no longer supported* `config.keyCodes`is no longer supported
