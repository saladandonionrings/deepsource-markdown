...
**ID:** `JS-A1001` | **Link:** [DeepSource](https://deepsource.com/directory/javascript/issues/JS-A1001)
...
* `/tmp`,* `/var/tmp`,* `/usr/tmp`,* `/run/lock`,* `/var/run/lock`,* `/Library/Caches`,* `/private/tmp`,* `/private/var/tmp`
