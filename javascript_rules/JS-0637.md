...
**ID:** `JS-0637` | **Link:** [DeepSource](https://deepsource.com/directory/javascript/issues/JS-0637)
...
* The directive doesn't have event name.* The directive has invalid modifier.* The directive doesn't have attribute value and any verb modifiers.
