...
**ID:** `JS-0356` | **Link:** [DeepSource](https://deepsource.com/directory/javascript/issues/JS-0356)
...
* It prevents unused modules from being loaded at runtime, improving performance, and preventing the compiler from loading metadata that will never be used.* It prevents conflicts that may occur when trying to reference another variable.
