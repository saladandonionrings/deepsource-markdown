...
**ID:** `JS-0795` | **Link:** [DeepSource](https://deepsource.com/directory/javascript/issues/JS-0795)
...
* Mixins introduce implicit dependencies* Mixins cause name clashes* Mixins cause snowballing complexity
