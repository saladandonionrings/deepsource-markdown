...
**ID:** `JS-0346` | **Link:** [DeepSource](https://deepsource.com/directory/javascript/issues/JS-0346)
...
* Arguments to the &&, || and ?: (ternary) operators* Conditions for if, for, while, and do-while statements* Base values of optional chain expressions
