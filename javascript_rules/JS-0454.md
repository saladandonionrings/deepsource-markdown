...
**ID:** `JS-0454` | **Link:** [DeepSource](https://deepsource.com/directory/javascript/issues/JS-0454)
...
* `>`can be replaced with`&gt`;* `"`can be replaced with`&quot`;,`&ldquo`;,`&#34;`or`&rdquo;`* `'`can be replaced with`&apos`;,`&lsquo;`,`&#39;`or`&rsquo;`* `}`can be replaced with`&#125`;
